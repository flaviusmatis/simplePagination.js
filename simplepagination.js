...
(function(factory) {
    ...
    var methods = {
        init: function(options) {
            ...
            this.each(function() {
                self.addClass(o.cssStyle + ' simple-pagination')
                    .data('pagination', o);
        ...
        _draw: function() {
            ...
            var $panel = tagName === 'UL' ? this : $('<ul' + (o.listStyle ? ' class="' + o.listStyle + '"' : '') + '></ul>')
                .appendTo(this);
            ...
            if (!o.invertPageOrder) {
                if (interval.end < o.pages && o.edges > 0) {
                    ...
                    if (o.useEndEdge) {
                        var begin1 = Math.max(o.pages - o.edges, interval.end);
                        for (i = begin1; i < o.pages; i++) {
                            methods._appendItem.call(this, i);
                        }
                    }
                }
                ...
                if (interval.start > 0 && o.edges > 0) {
                    ...
                    if (o.useEndEdge) {
                        var end1 = Math.min(o.edges, interval.start);
                        for (i = end1 - 1; i >= 0; i--) {
                            methods._appendItem.call(this, i);
                        }
                    }
        ...
        _ellipseClick: function($panel) {
            ...
            $ellip.addClass('clickable')
                .parent()
                .removeClass('disabled');
            $ellip.click(function(event) {
                if (!o.disable) {
                    var $this = $(this),
                        val = (parseInt($this.parent()
                            .prev()
                            .text(), 10) || 0) + 1;
                    $this
